...
// Default thinking tokens for normal conversations (0 = off, 10000 = normal, 50000 = deep)
export const DEFAULT_THINKING_TOKENS = parseInt(
  process.env.DEFAULT_THINKING_TOKENS || "10000",
  10
);
...
export const SESSION_DIR = "/tmp/claude-telegram-sessions";
export const SESSION_FILE = "/tmp/claude-telegram-session.json"; // Legacy default
